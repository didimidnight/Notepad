...
use NotepadBundle\Entity\Categorie;
...
class DefaultController extends Controller
{
    ...
    public function noteAction()
    {
    	...
    	$note = $em->getRepository('NotepadBundle:Note')->findAll();
    	if (!$note){
            return $this->render('NotepadBundle:Notes:Nonote.html.twig');
    		
    	}
       
       return $this->render('NotepadBundle:Notes:index.html.twig',array('note'=>$note));
    }
 	 /**
      ...
      public function addNoteAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($note)
            ...
            ->add('iDCategorie', EntityType::class, array('class' => 'NotepadBundle:Categorie','choice_label' => 'nom','label' => 'Catégorie'))
        ...
        return $this->render('NotepadBundle:Notes:AddNote.html.twig', array(
    ...
    */
    public function editNoteAction (request $request, $id)
    {
        ...
        return $this->render('NotepadBundle:Notes:AddCategorie.html.twig', array(
            'form' => $form->createView()));
    }
    ...
    */
    ...
    {
    	$em = $this->getDoctrine()->getManager();
        $cate = $em->getRepository('NotepadBundle:Categorie')->findAll();
        if (!$cate) {
            throw $this->createNotFoundException('Pas de categorie trouvée');
        }

  		return $this->render('NotepadBundle:Categories:ListeCategorie.html.twig',array('cate'=>$cate));
    }
    ...
    */
    ...
    {	
    	$em = $this->getDoctrine()->getManager();
    	$categorie = $em->getRepository('NotepadBundle:Categorie')->find($id);
    	if (!$categorie) {
          throw $this->createNotFoundException('Note not found');
        }
        ...
        return $this->render('NotepadBundle:Categories:AddCategorie.html.twig', array(
            'form' => $form->createView()));
    }
